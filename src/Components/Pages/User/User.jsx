...
const User = () => {
    ...
    const cashInBtn = async (casData) => {
        const { email, amount, pin, agentEmail } = casData
        const cashIn = {
            agentEmail,
            email,
            amount,
        ...
        try {
            const res = await axiosPublic.post(`/auth/login`, casData)
            if (!findAgent) {
                Swal.fire({
                    icon: "error",
                    title: "Oops...",
        ...
        <div className='m-10 ml-72'>
            ...
            <div className='grid grid-cols-2 gap-5'>
                <div className="max-w-7xl p-6 mt-6 bg-white rounded-md shadow-xl">
                    ...
                    <form onSubmit={handleSubmit(cashInBtn)}>
